                        ...
                        <div className="col-md-8">
                            <div className="card mb-4 position-relative">
                                <img 
                                    ...
                                    alt="Bất động sản" 
                                />
                                <div className="card-body position-absolute bottom-0 left-10 text-black overlay">
                                    <small className="text-muted">17/02/2025 08:09 * Tin tức</small>
                                    <h4 className="card-title mt-2">
                                        Thị Trường Chung Cư Hà Nội Vắng Bóng Nhà Đầu Tư
                                    </h4>
                                    <p className="card-text">
                                        Thị trường chung cư Hà Nội trong năm 2024 là cuộc hội tụ đồng đảo của cả người mua ở thực và giới đầu tư do mặt bằng giá liên tục lập đỉnh. Tuy nhiên, ngay từ đầu năm 2025, thị trường này đã có sự thay đổi khi nhà đầu tư vắng bóng và chỉ còn thu hút mối quan tâm của người mua ở thực.
                                    </p>
                                </div>
                            </div>
                        </div>
